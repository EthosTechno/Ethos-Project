      ...
      <div
        ...
        <slot
          ...
          <div
            ...
            :style="getStatusStyle(statusValue == 2 ? 'Canceled' : statusValue == 1 ? 'Completed' : 'Active')">
    ...
    <template
      ...
      <div
        ...
        <div
          ...
          <span v-if="status && option.name == 'Active'" class="active_status"></span>
          <span v-if="status && option.name == 'Canceled'" class="canceled_status"></span>
